...
emmet.exec(function(require, _) {
	...
	"html": {
      ...
      <!-- ================== 增加的缩写 ==================== -->
      "myimg":"<img src=\"http://www.igeekbar.com/igeekbar/laitu/300x200&text=hello world/222222/ffffff\" alt=\"占位图片\">",
      "myjq":"<script src=\"https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js\"></script>",
      "myjq":"<script src=\"https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js\"></script>",
      "myboot1":"<link href=\"https://cdn.bootcss.com/bootstrap/3.3.7/css/bootstrap.min.css\" rel=\"stylesheet\">",
      "myboot2":"<script src=\"https://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.min.js\"></script>",
      "myboot":"myboot1+myboot2",
      "myjs1":"<input type=\"button\" onclick=\"myDebug()\" value=\"进入调试\">",
      "myjs2":"script{${1:function myDebug() {console.log(\"请点击后面的网址，进入调试界面：\");}}}",
      "myjs": "!!!+html[lang=${lang}]>(head>meta[charset=UTF-8]+title{${1:Document}})+body>(myjs1+myjs2)",
      <!-- ================== 增加的缩写 ==================== -->
		}
	},
